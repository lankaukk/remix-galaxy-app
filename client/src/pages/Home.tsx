...
import couch from "@assets/stickers/couch.png";
...
const stickers = [
  { src: butternutSquash, alt: "butternut-squash", x: 100, y: 150, rotation: -12, size: 100 },
  { src: couch, alt: "couch", x: 300, y: 200, rotation: 8, size: 110 },
  ...
  { src: liveLaughLove, alt: "live-laugh-love", x: 900, y: 150, rotation: 10, size: 105 },
  { src: magician, alt: "magician", x: 400, y: 450, rotation: -15, size: 100 },
  { src: pillowsGrey, alt: "pillows-grey", x: 600, y: 350, rotation: 5, size: 90 },
  { src: pillowsPink, alt: "pillows-pink", x: 800, y: 400, rotation: -10, size: 95 },
  { src: saraFem, alt: "sara-fem", x: 200, y: 550, rotation: 12, size: 110 },
  { src: selfie2024, alt: "selfie-2024", x: 1000, y: 300, rotation: -7, size: 100 },
  { src: selfie2025, alt: "selfie-2025", x: 450, y: 600, rotation: 8, size: 105 },
