...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "right", className, children, closeButtonSize = "md", ...props }, ref) => {
  const closeButtonSizeClass = closeButtonSize === "lg" ? "h-6 w-6" : closeButtonSize === "sm" ? "h-3 w-3" : "h-4 w-4";
  const closeButtonPadding = closeButtonSize === "lg" ? "p-2" : "p-0";
    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close className={cn(
          ...
          closeButtonPadding,
          side === "bottom" ? "right-4 bottom-4" : "right-4 top-4"
        )}>
          <X className={closeButtonSizeClass} />
